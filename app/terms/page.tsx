        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 shadow-md rounded-lg p-6 sm:p-8">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2">Utiliser le Site d&apos;une manière qui pourrait l&apos;endommager, le désactiver, le surcharger ou le compromettre</li>
              <li className="mb-2">Accéder non autorisé aux systèmes ou réseaux connectés au Site</li>
              <li className="mb-2">Collecter ou recueillir des données personnelles d&apos;autres utilisateurs sans leur consentement</li>
              <li className="mb-2">Publier du contenu diffamatoire, obscène, offensant, haineux ou inflammatoire</li>
            ...
            <p className="mb-4">
              ...
              les lois sur le droit d&apos;auteur et autres lois sur la propriété intellectuelle.
            </p>
            <p className="mb-4">
              Vous pouvez consulter, télécharger et imprimer le contenu du Site pour votre usage personnel et non 
              commercial. Vous ne pouvez pas reproduire, distribuer, modifier, créer des œuvres dérivées, afficher 
              publiquement, exécuter publiquement, republier, télécharger, stocker ou transmettre tout matériel de notre 
            ...
            <p className="mb-4">
              ...
              transférable et pouvant faire l&apos;objet d&apos;une sous-licence pour utiliser, reproduire, modifier, adapter, 
              publier, traduire, distribuer et afficher ce contenu sur notre Site et sur nos plateformes de médias sociaux.
            </p>
            <p className="mb-4">
              Vous garantissez que tout contenu que vous soumettez n&apos;enfreint pas les droits de tiers et respecte les 
              présentes Conditions d&apos;utilisation. FlashInfos237 se réserve le droit de supprimer tout contenu qui viole 
            ...
            <p className="mb-4">
              ...
              disponibles sur le Site est à vos propres risques.
            </p>
            <p className="mb-4">
              Dans toute la mesure permise par la loi applicable, FlashInfos237 ne pourra être tenu responsable des 
              dommages directs, indirects, accessoires, consécutifs ou punitifs résultant de votre accès ou de votre 
            ...
            <p className="mb-4">
              ...
              dépenses, y compris, sans limitation, les frais juridiques et comptables, découlant de votre violation 
              des présentes Conditions d&apos;utilisation ou de votre utilisation du Site.
            </p>
            
            <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800">9. Loi applicable et juridiction</h2>
            <p className="mb-4">
              Les présentes Conditions d&apos;utilisation sont régies et interprétées conformément aux lois du Cameroun. Tout 
              litige découlant de ces conditions sera soumis à la compétence exclusive des tribunaux du Cameroun.
            </p>
            
            <h2 className="text-xl font-semibold mt-6 mb-3 text-gray-800">10. Contact</h2>
            <p className="mb-4">
